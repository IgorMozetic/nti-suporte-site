...
<div class="container">
    ...
    <div class="row"> <!--BOTOES CENTRAL DE SERVICOS E MANUAIS E TUTORIAIS-->
            ...
            <div class="col-sm-12 col-md-6">
                <a class="" href="<?php site_url(); ?>/?post_type=docs"> <img src="wp-content\themes\NTITheme2\images\manuais_tutoriais.png" class="card-img-top" alt="..."></i></a>
            </div>
    </div>
            ...
            <div class="card">
                ...
                <div>
                    <div class="sistemasinstitucionais">
                        ...
                        <a class="" href="<?php site_url(); ?>/?page_id=1859">
