...
#instalação do pacote smbclient:
...
echo "  Digite '1' se irá imprimir em alguma das impressoras listadas abaixo:" 
echo "    - impressoras da Reitoria (bloco A, 1º andar)"
echo "    - impressora da PROAP Psico (bloco A, térreo)"
echo "    - impressora da Corregedoria (bloco A, subsolo)"
echo "    - impressora do NTI/SUGEPE (bloco A, subsolo)"
echo "    - impressora do CCNH, Divisão Adm. (bloco A, torre 3, 6º andar)"
echo "    - impressora da PU, corredor (bloco A, subsolo)"
echo "    - impressora da PU, infraestrutura (bloco A, subsolo)"
echo "    - impressora da PROPES, Biotério (bloco A, subsolo)"
echo "    - impressora da PROPES, LS08 e LS09 (bloco A, subsolo)"
echo "    - impressora da Ouvidoria (bloco A, subsolo)"
echo "    - impressora do DSQV, antigo NAS (bloco A, torre 1, 3º andar)"
echo "    - impressora do NTI (bloco L, 7º andar)"
echo "  Digite '2' para outras impressoras de rede"


read opcao

if [ $opcao == '1' ];then
sistemaImpressao="Impressao%20UFABC"
fi

if [ $opcao == '2' ];then
sistemaImpressao="Lexmark%20Server"
fi


hostServidor="172.17.3.227"
porta="445"
dominio="UFABC_DOMINIO"
...
lpadmin -p Impressora-de-Rede -o printer-is-shared=true -v smb://$usuario:$senha@$dominio/$hostServidor:$porta/$sistemaImpressao -E
