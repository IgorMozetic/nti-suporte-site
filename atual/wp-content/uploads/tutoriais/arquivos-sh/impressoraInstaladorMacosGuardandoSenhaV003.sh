...
lpadmin -p Impressora-de-Rede-UFABC -o printer-is-shared=true -v smb://$usuario:$senha@UFABC_DOMINIO/172.17.3.227:445/Lexmark%20Server -m drv:///sample.drv/generic.ppd -E
